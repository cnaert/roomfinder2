...
def index():
	...
	return render_template('home.html', room_list=room_list, title="Booking tool", current_time=datetime.datetime.now(), book_url=book_url)
...
if __name__ == '__main__':
    ...
    try:
    	app.run(debug=True, host='0.0.0.0', port=int("8082"))
    except:
    	try:
    		app.run(debug=True, host='0.0.0.0', port=int("8082"))
    	except:
